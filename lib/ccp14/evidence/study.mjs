...
const sources = [
	{
		id: "mintransporte-resolution-108-2015-invias-copy",
		issuingAuthority: "Ministerio de Transporte de Colombia",
		...
		officialUrl:
			"https://www.invias.gov.co/loader.php?lServicio=Tools2&lTipo=descargas&lFuncion=descargar&idFile=29585",
		retrievedOn: "2026-07-28",
		redistribution: {
			decision: "external-only",
			rationale:
				"The current INVÍAS portal serves the locked official bytes; redistribution permission was not established.",
		},
	...
	},
	{
		...
		redistribution: {
			decision: "external-only",
			rationale:
				"The current INVÍAS portal serves the exact locked ZIP containing this Section 3 PDF; redistribution permission was not established.",
		},
		mediaType: "application/pdf",
		pageCount: 140,
...
const applicabilityCitations = [
	{
		...
		sourceDocumentId: "mintransporte-resolution-108-2015-invias-copy",
		physicalPage: 1,
		printedPage: null,
