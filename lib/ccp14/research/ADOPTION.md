...
MinTransporte Resolution 0000108 of 26 January 2015 adopts the attached *Norma Colombiana de Diseño de Puentes CCP-2014* for studies, design, construction, and maintenance of bridges on the National Road Network under INVÍAS responsibility. It was enacted and signed by the Minister of Transport. Article 2 makes the resolution effective upon publication and repeals contrary provisions, expressly including Resolution 3600 of 1996. The instrument was published in *Diario Oficial* No. 49,406 on 26 January 2015.

The resolution and the official CCP-14 archive are treated as separate locked sources: the MinTransporte resolution establishes applicability, while the INVÍAS archive supplies the controlling technical clauses and tables. On 28 July 2026 the migrated INVÍAS portal served copies of both assets directly. Current file ID `29585` reproduces the locked 564,302-byte MinTransporte resolution PDF exactly, and current file ID `29584` reproduces the locked 40,260,753-byte INVÍAS technical ZIP exactly. The current URLs, catalog records, hashes, byte counts, and legacy URLs are recorded in `source-locks.json` and `invias-portal-audit.json`.
